    ...
    \renewcommand{\OCname}{TransientBoltedSCR3}


    \subsection{Transient fault: full short-circuit (150 ms, $SCR=3$)}
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI16z1ThreePhaseFaultTransientBoltedSCR3}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \GridCurvesItZone
    \\[2\baselineskip]
    Go to  {{ linkPCSI16z1ThreePhaseFaultTransientBoltedSCR3 }}

    \subsubsection{Analysis of results}

    \noindent Dynamic behaviour: {{ stabilizedPCSI16z1ThreePhaseFaultTransientBoltedSCR3 }}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lccccccccc@{}}
            ...
            \midrule
            \BLOCK{for row in rmPCSI16z1ThreePhaseFaultTransientBoltedSCR3}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lccccccccc@{}}
            ...
            \midrule
            \\
            \BLOCK{for row in thmPCSI16z1ThreePhaseFaultTransientBoltedSCR3}
            {{row[0]}} & {{row[1]}} & {{row[2]}} & {{row[3]}} & {{row[4]}} & {{row[5]}} & {{row[6]}} & {{row[7]}} & {{row[8]}} & {{row[9]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lcccccccccc@{}}
            ...
            \midrule
            \\
            \BLOCK{for row in emPCSI16z1ThreePhaseFaultTransientBoltedSCR3}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in aprPCSI16z1ThreePhaseFaultTransientBoltedSCR3}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSI16z1ThreePhaseFaultTransientBoltedSCR3}
            {{row[0]}} & {{row[1]}} & {{row[2]}}  & {{row[3]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
