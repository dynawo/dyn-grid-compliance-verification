    ...
    \noindent Dynamic behaviour: {{ stabilizedPCSI16z3QSetPointStepInc10 }}
    ...
    \begin{minipage}{\linewidth} % because otherwise, the footnote does not show
        ...
        \begin{tabular}{lccccc}
            ...
            \midrule
            \BLOCK{for row in temPCSI16z3QSetPointStepInc10}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSI16z3QSetPointStepInc10}
