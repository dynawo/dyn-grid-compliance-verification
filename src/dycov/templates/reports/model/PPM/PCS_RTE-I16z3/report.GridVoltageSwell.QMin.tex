    ...
    \renewcommand{\OCname}{QMin}


    \subsection{Test I7 - Voltage swell ride-through ($Q_{min}$)}
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI16z3GridVoltageSwellQMin}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \GridCurvesItZthree
    \\[2\baselineskip]
    Go to  {{ linkPCSI16z3GridVoltageSwellQMin }}

    \subsubsection{Analysis of results}

    \noindent Dynamic behaviour: {{ stabilizedPCSI16z3GridVoltageSwellQMin }}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lccccccccc@{}}
            ...
            \midrule
            \BLOCK{for row in rmPCSI16z3GridVoltageSwellQMin}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lccccccccc@{}}
            ...
            & {MXE}      & {ME}       & {MAE}      & {MXE}      & {ME}       & {MAE}      & {MXE}      & {ME}       & {MAE}      \\
            \midrule
            \BLOCK{for row in thmPCSI16z3GridVoltageSwellQMin}
            {{row[0]}} & {{row[1]}} & {{row[2]}} & {{row[3]}} & {{row[4]}} & {{row[5]}} & {{row[6]}} & {{row[7]}} & {{row[8]}} & {{row[9]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lcccccccccc@{}}
            ...
            \midrule
            \BLOCK{for row in emPCSI16z3GridVoltageSwellQMin}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSI16z3GridVoltageSwellQMin}
