    ...
    \renewcommand{\OCname}{BReactance} % DTR pcs definition
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI16z3USetPointStepBReactance}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \noindent Dynamic behaviour: {{ stabilizedPCSI16z3USetPointStepBReactance }}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSI16z3USetPointStepBReactance}
