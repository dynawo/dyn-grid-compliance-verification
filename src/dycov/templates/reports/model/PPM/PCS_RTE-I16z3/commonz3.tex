...
%
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_IpIt_PCS_RTE-I16z3.\DTRPcs.\OCname}
        \begin{minipage}[t]{0.8\textwidth}
            \small Active current output Ip, measured in low voltage at the injector terminal.
        \end{minipage}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_IqIt_PCS_RTE-I16z3.\DTRPcs.\OCname}
        \begin{minipage}[t]{0.8\textwidth}
            \small Reactive current output Iq, measured in low voltage at the injector terminal.
        \end{minipage}
    \end{minipage}
%
    \vspace{0.5cm}
