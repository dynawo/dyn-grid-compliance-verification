    ...
    \renewcommand{\OCname}{OperatingCondition3}


    \subsection{Step response to control changes: P-setpoint drop}
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSIz1Benchmark2OperatingCondition3}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \GridCurvesDummy
    \\[2\baselineskip]
    Go to  {{ linkPCSIz1Benchmark2OperatingCondition3 }}

    \subsubsection{Analysis of results}

    \noindent Dynamic behaviour: {{ stabilizedPCSIz1Benchmark2OperatingCondition3 }}
    ...
    \begin{center}
        ...
        \begin{tabular}{lccccccc}
            ...
            \midrule
            \BLOCK{for row in rmPCSIz1Benchmark2OperatingCondition3}
    ...
    \begin{center}
        ...
        \begin{tabular}{lcccccc}
            ...
            & {MXE}      & {ME}       & {MAE}      & {MXE}      & {ME}       & {MAE}      \\
            \midrule
            \BLOCK{for row in thmPCSIz1Benchmark2OperatingCondition3}
            {{row[0]}} & {{row[1]}} & {{row[2]}} & {{row[3]}} & {{row[4]}} & {{row[5]}} & {{row[6]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{center}
        ...
        \begin{tabular}{lccccccc}
            ...
            \midrule
            \BLOCK{for row in emPCSIz1Benchmark2OperatingCondition3}
    ...
    \begin{minipage}{\linewidth} % because otherwise, the footnote does not show
        ...
        \begin{tabular}{lccccc}
            ...
            \midrule
            \BLOCK{for row in temPCSIz1Benchmark2OperatingCondition3}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSIz1Benchmark2OperatingCondition3}
