    ...
    \renewcommand{\OCname}{OperatingCondition1}


    \subsection{Transient fault: full short-circuit ($SCR=3, 150ms$)}
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSIz1Benchmark1OperatingCondition1}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \GridCurvesDummy
    \\[2\baselineskip]
    Go to  {{ linkPCSIz1Benchmark1OperatingCondition1 }}

    \subsubsection{Analysis of results}

    \noindent Dynamic behaviour: {{ stabilizedPCSIz1Benchmark1OperatingCondition1 }}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lccccccccc@{}}
            ...
            \midrule
            \BLOCK{for row in rmPCSIz1Benchmark1OperatingCondition1}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lccccccccc@{}}
            ...
            \midrule
            \\
            \BLOCK{for row in thmPCSIz1Benchmark1OperatingCondition1}
            {{row[0]}} & {{row[1]}} & {{row[2]}} & {{row[3]}} & {{row[4]}} & {{row[5]}} & {{row[6]}} & {{row[7]}} & {{row[8]}} & {{row[9]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lcccccccccc@{}}
            ...
            \midrule
            \\
            \BLOCK{for row in emPCSIz1Benchmark1OperatingCondition1}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSIz1Benchmark1OperatingCondition1}
