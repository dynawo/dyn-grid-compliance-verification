...
%     The vertical dashed line marks the rise time $T_{85U}$.
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \begin{minipage}[t]{0.8\textwidth}
            \small Magnitude controlled by the Plant-level voltage regulation. All BESS
            units are plotted on the same graph. The gray dotted
            line shows the Plant-level voltage regulation setpoint.
        \end{minipage}
    \end{minipage}
%
    \vspace{0.5cm}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_Ip_PCS_Iz1.\DTRPcs.\OCname}
        \begin{minipage}[t]{0.8\textwidth}
...
%
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_Iq_PCS_Iz1.\DTRPcs.\OCname}
        \begin{minipage}[t]{0.8\textwidth}
