    ...
    \noindent Dynamic behaviour: {{ stabilizedPCSIz1Benchmark2OperatingCondition4 }}
    ...
    \begin{minipage}{\linewidth} % because otherwise, the footnote does not show
        ...
        \begin{tabular}{lccccc}
            ...
            \midrule
            \BLOCK{for row in temPCSIz1Benchmark2OperatingCondition4}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSIz1Benchmark2OperatingCondition4}
