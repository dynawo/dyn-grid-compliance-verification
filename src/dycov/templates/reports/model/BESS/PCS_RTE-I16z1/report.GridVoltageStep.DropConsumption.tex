    ...
    \renewcommand{\OCname}{DropConsumption}


    \subsection{Step response to grid changes in consumption: V dip}

    Checks for compliant behavior of the generating unit under a grid scenario where there
    is a $10\%$ voltage step decrease on AC source.
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI16z1GridVoltageStepDropConsumption}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \GridCurvesZone
    \\[2\baselineskip]
    Go to  {{ linkPCSI16z1GridVoltageStepDropConsumption }}

    \subsubsection{Analysis of results}

    \noindent Dynamic behaviour: {{ stabilizedPCSI16z1GridVoltageStepDropConsumption }}
    ...
    \begin{center}
        ...
        \begin{tabular}{lcccccc}
            ...
            \midrule
            \BLOCK{for row in rmPCSI16z1GridVoltageStepDropConsumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{lcccccc}
            ...
            & {MXE}      & {ME}       & {MAE}      & {MXE}      & {ME}       & {MAE}      \\
            \midrule
            \BLOCK{for row in thmPCSI16z1GridVoltageStepDropConsumption}
            {{row[0]}} & {{row[1]}} & {{row[2]}} & {{row[3]}} & {{row[4]}} & {{row[5]}} & {{row[6]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{center}
        ...
        \begin{tabular}{lccccccc}
            ...
            \midrule
            \BLOCK{for row in emPCSI16z1GridVoltageStepDropConsumption}
    ...
    \begin{minipage}{\linewidth} % because otherwise, the footnote does not show
        ...
        \begin{tabular}{lccccc}
            ...
            \midrule
            \BLOCK{for row in temPCSI16z1GridVoltageStepDropConsumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSI16z1GridVoltageStepDropConsumption}
