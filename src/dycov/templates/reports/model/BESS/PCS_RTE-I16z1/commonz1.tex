...
%     The vertical dashed line marks the rise time $T_{85U}$.
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \begin{minipage}[t]{0.8\textwidth}
            \small Magnitude controlled by voltage control, in pu.
        \end{minipage}
    \end{minipage}
%
    \vspace{0.5cm}
...
%
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_Ire_PCS_RTE-I16z1.\DTRPcs.\OCname}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_Iim_PCS_RTE-I16z1.\DTRPcs.\OCname}
        \begin{minipage}[t]{0.8\textwidth}
