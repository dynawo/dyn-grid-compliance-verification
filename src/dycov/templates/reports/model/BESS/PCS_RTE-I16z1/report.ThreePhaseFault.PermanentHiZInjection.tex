    ...
    \renewcommand{\OCname}{PermanentHiZInjection}


    \subsection{Permanent fault in injection: High-impedance fault ($SCR=10, V=0.5Un$)}
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI16z1ThreePhaseFaultPermanentHiZInjection}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \GridCurvesItZone
    \\[2\baselineskip]
    Go to  {{ linkPCSI16z1ThreePhaseFaultPermanentHiZInjection }}

    \subsubsection{Analysis of results}

    \noindent Dynamic behaviour: {{ stabilizedPCSI16z1ThreePhaseFaultPermanentHiZInjection }}
    ...
    \begin{center}
        ...
        \begin{tabular}{lcccccc}
            ...
            \midrule
            \BLOCK{for row in rmPCSI16z1ThreePhaseFaultPermanentHiZInjection}
    ...
    \begin{center}
        ...
        \begin{tabular}{lcccccc}
            ...
            & {MXE}      & {ME}       & {MAE}      & {MXE}      & {ME}       & {MAE}      \\
            \midrule
            \BLOCK{for row in thmPCSI16z1ThreePhaseFaultPermanentHiZInjection}
            {{row[0]}} & {{row[1]}} & {{row[2]}} & {{row[3]}} & {{row[4]}} & {{row[5]}} & {{row[6]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{center}
        ...
        \begin{tabular}{lccccccc}
            ...
            \midrule
            \BLOCK{for row in emPCSI16z1ThreePhaseFaultPermanentHiZInjection}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in aprPCSI16z1ThreePhaseFaultPermanentHiZInjection}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSI16z1ThreePhaseFaultPermanentHiZInjection}
            {{row[0]}} & {{row[1]}} & {{row[2]}}  & {{row[3]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
