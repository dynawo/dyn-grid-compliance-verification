    ...
    \noindent Dynamic behaviour: {{ stabilizedPCSI16z1ThreePhaseFaultTransientHiZTc500Consumption }}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lcccccccccc@{}}
            ...
            \midrule
            \BLOCK{for row in emPCSI16z1ThreePhaseFaultTransientHiZTc500Consumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in aprPCSI16z1ThreePhaseFaultTransientHiZTc500Consumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSI16z1ThreePhaseFaultTransientHiZTc500Consumption}
            {{row[0]}} & {{row[1]}} & {{row[2]}}  & {{row[3]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
