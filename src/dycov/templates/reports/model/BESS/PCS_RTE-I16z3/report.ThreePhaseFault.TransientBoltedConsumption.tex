    ...
    \begin{itemize}
        ...
        \item The active and reactive currents at the injector's low voltage terminal. All BESS
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \begin{minipage}[t]{0.8\textwidth}
            ...
            The gray dotted line show the Plant-level voltage regulation setpoint.
        \end{minipage}
    \end{minipage}
