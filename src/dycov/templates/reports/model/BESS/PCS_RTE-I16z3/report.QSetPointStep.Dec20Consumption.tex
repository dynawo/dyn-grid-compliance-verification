    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% PCS I2 Ext Dec20 Setpoint Q %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    % DTRPCS for cicuits
    {{ waterMarkText }}

    \renewcommand{\DTRPcs}{QSetPointStep} % DTR pcs definition
    \renewcommand{\OCname}{Dec20Consumption}


    \subsection{Test I2 - Step response to Q-setpoint change in consumption ($-20\%$)}
    ...
    \begin{description}
        ...
        \begin{itemize}
            ...
            \item $Q = 0.1*P_{max\_consumption\_unite}$
            \item $U = U_{dim}$
        \end{itemize}
    \end{description}
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI16z3QSetPointStepDec20Consumption}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \GridCurvesZthree
    \\[2\baselineskip]
    Go to  {{ linkPCSI16z3QSetPointStepDec20Consumption }}

    \subsubsection{Analysis of results}

    \noindent Dynamic behaviour: {{ stabilizedPCSI16z3QSetPointStepDec20Consumption }}
    ...
    \begin{center}
        ...
        \begin{tabular}{lcccccc}
            ...
            \midrule
            \BLOCK{for row in rmPCSI16z3QSetPointStepDec20Consumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{lcccccc}
            ...
            & {MXE}      & {ME}       & {MAE}      & {MXE}      & {ME}       & {MAE}      \\
            \midrule
            \BLOCK{for row in thmPCSI16z3QSetPointStepDec20Consumption}
            {{row[0]}} & {{row[1]}} & {{row[2]}} & {{row[3]}} & {{row[4]}} & {{row[5]}} & {{row[6]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{center}
        ...
        \begin{tabular}{lccccccc}
            ...
            \midrule
            \BLOCK{for row in emPCSI16z3QSetPointStepDec20Consumption}
    ...
    \begin{minipage}{\linewidth} % because otherwise, the footnote does not show
        ...
        \begin{tabular}{lccccc}
            ...
            \midrule
            \BLOCK{for row in temPCSI16z3QSetPointStepDec20Consumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSI16z3QSetPointStepDec20Consumption}
