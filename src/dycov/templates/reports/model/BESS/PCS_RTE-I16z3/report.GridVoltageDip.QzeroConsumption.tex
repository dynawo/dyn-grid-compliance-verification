    ...
    \renewcommand{\OCname}{QzeroConsumption}


    \subsection{Test I6 - Voltage sag ride-through in consumption}
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI16z3GridVoltageDipQzeroConsumption}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \GridCurvesItZthree
    \\[2\baselineskip]
    Go to  {{ linkPCSI16z3GridVoltageDipQzeroConsumption }}

    \subsubsection{Analysis of results}

    \noindent Dynamic behaviour: {{ stabilizedPCSI16z3GridVoltageDipQzeroConsumption }}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lccccccccc@{}}
            ...
            \midrule
            \BLOCK{for row in rmPCSI16z3GridVoltageDipQzeroConsumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lccccccccc@{}}
            ...
            & {MXE}      & {ME}       & {MAE}      & {MXE}      & {ME}       & {MAE}      & {MXE}      & {ME}       & {MAE}      \\
            \midrule
            \BLOCK{for row in thmPCSI16z3GridVoltageDipQzeroConsumption}
            {{row[0]}} & {{row[1]}} & {{row[2]}} & {{row[3]}} & {{row[4]}} & {{row[5]}} & {{row[6]}} & {{row[7]}} & {{row[8]}} & {{row[9]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lcccccccccc@{}}
            ...
            \midrule
            \BLOCK{for row in emPCSI16z3GridVoltageDipQzeroConsumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in aprPCSI16z3GridVoltageDipQzeroConsumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSI16z3GridVoltageDipQzeroConsumption}
            {{row[0]}} & {{row[1]}} & {{row[2]}}  & {{row[3]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
