    ...
    \renewcommand{\OCname}{DeltaP10DeltaQ4Consumption}


    \subsection{Test I10 - Islanding event in consumption}
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI16z3IslandingDeltaP10DeltaQ4Consumption}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \GridCurvesZthree
    \\[2\baselineskip]
    Go to  {{ linkPCSI16z3IslandingDeltaP10DeltaQ4Consumption }}

    \subsubsection{Analysis of results}

    \noindent Dynamic behaviour: {{ stabilizedPCSI16z3IslandingDeltaP10DeltaQ4Consumption }}
...
%\noindent No analysis is needed in PCS \DTRPcs.
    \begin{center}
        ...
        \begin{tabular}{@{}lcccccc@{}}
            ...
            \midrule
            \BLOCK{for row in rmPCSI16z3IslandingDeltaP10DeltaQ4Consumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lcccccc@{}}
            ...
            & {MXE}      & {ME}       & {MAE}      & {MXE}      & {ME}       & {MAE}      \\
            \midrule
            \BLOCK{for row in thmPCSI16z3IslandingDeltaP10DeltaQ4Consumption}
            {{row[0]}} & {{row[1]}} & {{row[2]}} & {{row[3]}} & {{row[4]}} & {{row[5]}} & {{row[6]}} \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lccccccc@{}}
            ...
            \midrule
            \BLOCK{for row in emPCSI16z3IslandingDeltaP10DeltaQ4Consumption}
    ...
    \begin{center}
        ...
        \begin{tabular}{cllc}
            ...
            \midrule
            \BLOCK{for row in ssemPCSI16z3IslandingDeltaP10DeltaQ4Consumption}
