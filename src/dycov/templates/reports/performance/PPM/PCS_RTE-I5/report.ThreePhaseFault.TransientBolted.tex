    ...
    \begin{itemize}
        ...
        \item The active and reactive currents at the injector's low voltage terminal. All PPM
...
% For now we won't use floats for figures, to get more precise placement
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \begin{minipage}[t]{0.8\textwidth}
            ...
            The gray dotted line show the Plant-level voltage regulation setpoint. All PPM units are plotted on the same
            graph.
        \end{minipage}
    \end{minipage}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_UIt_PCS_RTE-I5.ThreePhaseFault.TransientBolted}
        \begin{minipage}[t]{0.8\textwidth}
