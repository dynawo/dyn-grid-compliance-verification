...
% For now we won't use floats for figures, to get more precise placement
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_IpIt_PCS_RTE-I5.ThreePhaseFault.TransientBolted}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_IqIt_PCS_RTE-I5.ThreePhaseFault.TransientBolted}
        \begin{minipage}[t]{0.8\textwidth}
