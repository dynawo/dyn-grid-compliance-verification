    \subsection{Overview of DTR PCS \DTRPcs{} ($X_\text{cc} = X_b$)}
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSIBenchmark1OperatingCondition2}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{itemize}
        ...
        \item Rotor speed.
        \item Magnitude controlled by the Plant-level voltage regulation.
    \end{itemize}
...
% For now we won't use floats for figures, to get more precise placement
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_V_PCS_I.Benchmark1.OperatingCondition2}
    ...
    \hfill
        \begin{minipage}[t]{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{fig_Ustator_PCS_I.Benchmark1.OperatingCondition2}
            \begin{minipage}[t]{0.8\textwidth}
                \small Stator voltage magnitude. The gray dotted line show
                the Plant-level voltage regulation setpoint.
            \end{minipage}
        \end{minipage}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_P_PCS_I.Benchmark1.OperatingCondition2}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_Q_PCS_I.Benchmark1.OperatingCondition2}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_WRef_PCS_I.Benchmark1.OperatingCondition2}
        \begin{minipage}[t]{0.8\textwidth}
            \small Rotor speed.
        \end{minipage}
    \end{minipage}
    \\[2\baselineskip]
    Go to  {{ linkPCSIBenchmark1OperatingCondition2 }}
    ...
    \begin{center}
        \begin{tabular}{lc}
            ...
            \midrule
            \BLOCK{for row in rmPCSIBenchmark1OperatingCondition2}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{center}
        \begin{tabular}{lcc}
            ...
            \midrule
            \BLOCK{for row in cmPCSIBenchmark1OperatingCondition2}
            {{row[0]}}     & {{row[1]}}                         & {{row[2]}}                              \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
