    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI6GridVoltageDipQzeroConsumption}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
...
% For now we won't use floats for figures, to get more precise placement
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_V_PCS_RTE-I6.GridVoltageDip.QzeroConsumption}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_Ustator_PCS_RTE-I6.GridVoltageDip.QzeroConsumption}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_P_PCS_RTE-I6.GridVoltageDip.QzeroConsumption}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_Q_PCS_RTE-I6.GridVoltageDip.QzeroConsumption}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_I_PCS_RTE-I6.GridVoltageDip.QzeroConsumption}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_UIt_PCS_RTE-I6.GridVoltageDip.QzeroConsumption}
        \begin{minipage}[t]{0.8\textwidth}
            \small Low voltage at the injector terminal.
        \end{minipage}
    \end{minipage}
    \\[2\baselineskip]
    Go to  {{ linkPCSI6GridVoltageDipQzeroConsumption }}
    ...
    \begin{center}
        \begin{tabular}{lc}
            ...
            \midrule
            \BLOCK{for row in rmPCSI6GridVoltageDipQzeroConsumption}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{description}
        ...
        \item[Rise time $T_{85U}$:] time at which the voltage at the
    ...
    \begin{center}
        \begin{tabular}{lcc}
            ...
            \midrule
            \BLOCK{for row in cmPCSI6GridVoltageDipQzeroConsumption}
            {{row[0]}}     & {{row[1]}}                         & {{row[2]}}                              \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
