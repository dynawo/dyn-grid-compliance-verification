...
% For now we won't use floats for figures, to get more precise placement
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \begin{minipage}[t]{0.8\textwidth}
            \small Magnitude controlled by the Plant-level voltage regulation: modulus of the voltage at the REPC.
            The gray dotted line show the Plant-level voltage regulation setpoint. All BESS units are plotted on the same
            graph.
        \end{minipage}
    \end{minipage}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \begin{minipage}[t]{0.8\textwidth}
            \small active (light blue line) and reactive (violet line) currents in low voltage 
            at the injector terminal. All PPM units are plotted on the same graph.
        \end{minipage}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
