    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI5ThreePhaseFaultTransientBoltedInjection}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{itemize}
        ...
        \item Active current in low voltage at the injector terminal.
        \item Reactive current in low voltage at the injector terminal.
...
% For now we won't use floats for figures, to get more precise placement
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_V_PCS_RTE-I5.ThreePhaseFault.TransientBoltedInjection}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_Ustator_PCS_RTE-I5.ThreePhaseFault.TransientBoltedInjection}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_P_PCS_RTE-I5.ThreePhaseFault.TransientBoltedInjection}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_Q_PCS_RTE-I5.ThreePhaseFault.TransientBoltedInjection}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_IpIt_PCS_RTE-I5.ThreePhaseFault.TransientBoltedInjection}
        \begin{minipage}[t]{0.8\textwidth}
            \small Active current in low voltage at the injector terminal.
        \end{minipage}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_IqIt_PCS_RTE-I5.ThreePhaseFault.TransientBoltedInjection}
        \begin{minipage}[t]{0.8\textwidth}
            \small Reactive current in low voltage at the injector terminal.
        \end{minipage}
    \end{minipage}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_UIt_PCS_RTE-I5.ThreePhaseFault.TransientBoltedInjection}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_I_PCS_RTE-I5.ThreePhaseFault.TransientBoltedInjection}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_Tap_PCS_RTE-I5.ThreePhaseFault.TransientBoltedInjection}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \end{minipage}
    \\[2\baselineskip]
    Go to  {{ linkPCSI5ThreePhaseFaultTransientBoltedInjection }}
    ...
    \begin{center}
        \begin{tabular}{lc}
            ...
            \midrule
            \BLOCK{for row in rmPCSI5ThreePhaseFaultTransientBoltedInjection}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
    ...
    \begin{minipage}{\linewidth} % because otherwise, the footnote does not show
        \begin{tabular}{lcc}
            ...
            \midrule
            \BLOCK{for row in cmPCSI5ThreePhaseFaultTransientBoltedInjection}
            {{row[0]}}     & {{row[1]}}                         & {{row[2]}}                              \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
