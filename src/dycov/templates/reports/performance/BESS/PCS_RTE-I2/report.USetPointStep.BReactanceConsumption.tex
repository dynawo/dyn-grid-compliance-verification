    \subsection{Overview of DTR PCS \DTRPcs{} in consumption ($X_\text{cc} = X_b$)}
...
% For now we won't use floats for figures, to get more precise placement
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_V_PCS_RTE-I2.USetPointStep.BReactanceConsumption}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_Ustator_PCS_RTE-I2.USetPointStep.BReactanceConsumption}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_P_PCS_RTE-I2.USetPointStep.BReactanceConsumption}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_Q_PCS_RTE-I2.USetPointStep.BReactanceConsumption}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{center}
        \begin{tabular}{lcc}
            ...
            \midrule
            \BLOCK{for row in cmPCSI2USetPointStepBReactanceConsumption}
            {{row[0]}}     & {{row[1]}}                         & {{row[2]}}                              \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
