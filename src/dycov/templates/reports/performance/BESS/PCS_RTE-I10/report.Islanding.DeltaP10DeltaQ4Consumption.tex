    ...
    \begin{description}
        ...
        \begin{itemize}
            \item $P = 0.8 P_{max\_consumption\_unite}$
            \item $Q = 0$
            \item $U = U_{dim}$
    ...
    \begin{center}
        \begin{tabular}{lc}
           ...
           \textbf{Parameter} & \textbf{Value (default)} \\
            \midrule
            \BLOCK{for row in solverPCSI10IslandingDeltaP10DeltaQ4Consumption}
            {{row[0]}}         & {{row[1]}}                         \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
...
% For now we won't use floats for figures, to get more precise placement
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_V_PCS_RTE-I10.Islanding.DeltaP10DeltaQ4Consumption}
    ...
    \hfill
        \begin{minipage}[t]{0.48\textwidth}
            \centering
            \includegraphics[width=\textwidth]{\Producer_fig_Ustator_PCS_RTE-I10.Islanding.DeltaP10DeltaQ4Consumption}
            \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_P_PCS_RTE-I10.Islanding.DeltaP10DeltaQ4Consumption}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_Q_PCS_RTE-I10.Islanding.DeltaP10DeltaQ4Consumption}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{\Producer_fig_WRef_PCS_RTE-I10.Islanding.DeltaP10DeltaQ4Consumption}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \end{minipage}
    \\[2\baselineskip]
    Go to  {{ linkPCSI10IslandingDeltaP10DeltaQ4Consumption }}
    ...
    \begin{minipage}{\linewidth} % because otherwise, the footnote does not show
        \begin{tabular}{lcc}
            ...
            \midrule
            \BLOCK{for row in cmPCSI10IslandingDeltaP10DeltaQ4Consumption}
            {{row[0]}}     & {{row[1]}}                         & {{row[2]}}                              \\
            \BLOCK{endfor}
            \bottomrule
        \end{tabular}
