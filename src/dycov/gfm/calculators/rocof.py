...
class RoCoF(GFMCalculator):
    ...
    def _calculate_delta_p_for_damping(
        ...
        # RoCoF events simulate finite variation via superimposed step responses
    ...
    def _get_envelopes(
        ...
        # Force monotonic recovery trajectory
        ...
        # Execute tunnel ceiling validation enforcing strict physical output scaling
        p_down_unlimited = np.where(
