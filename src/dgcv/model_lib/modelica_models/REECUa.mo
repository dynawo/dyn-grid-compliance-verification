model REECUa "WECC Electrical Control type A"
  import Modelica;
  import Dynawo;
  import Dynawo.Types;
  ...
  Modelica.Blocks.Interfaces.RealInput VRefConst1(start = VRef1Pu) annotation(
...
equation
  ...
  connect(VRefConst1, add2.u1) annotation(
