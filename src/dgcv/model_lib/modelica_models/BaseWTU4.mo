partial model BaseWTU4 "Partial base model for the WECC Wind Turbine models including the electrical control, the generator control, the injector, the measurements and the equivalent branch connection to the grid"
  import Dynawo;
  import Dynawo.Types;
