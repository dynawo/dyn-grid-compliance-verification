...
% For now we won't use floats for figures, to get more precise placement
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_V_PCS_RTE-I8.LoadShedDisturbance.PmaxQzero}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_Ustator_PCS_RTE-I8.LoadShedDisturbance.PmaxQzero}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_P_PCS_RTE-I8.LoadShedDisturbance.PmaxQzero}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_Q_PCS_RTE-I8.LoadShedDisturbance.PmaxQzero}
        \begin{minipage}[t]{0.8\textwidth}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_W_PCS_RTE-I8.LoadShedDisturbance.PmaxQzero}
        \begin{minipage}[t]{0.8\textwidth}
            \small Rotor speed.
        \end{minipage}
    \end{minipage}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{fig_WRef_PCS_RTE-I8.LoadShedDisturbance.PmaxQzero}
        \begin{minipage}[t]{0.8\textwidth}
