...
from dgcv.dynawo.translator import dynawo_translator, get_generator_family_level
from dgcv.logging.logging import dgcv_logging
from dgcv.model.parameters import (
    Gen_params,
    Line_params,
    Load_init,
    Load_params,
...
def _append_generator(
    ...
    generators.append(Gen_params(gen_id, lib, connectedXmfr, imax, par_id, P, Q))
...
def _set_control_mode(generator, parset, ns, generator_control_mode):
