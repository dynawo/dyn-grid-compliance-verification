...
def _create_producer_ini_file(
    ...
    producer_ini_txt = (
        ...
        f"u_nom =\n"
        f"# s_nom is the nominal apparent power of the generator unit (in MVA)\n"
        f"s_nom =\n"
        f"# q_max is the maximum reactive power of the generator unit (in MVar)\n"
        f"q_max =\n"
        f"# q_min is the minimum reactive power of the generator unit (in MVar)\n"
        f"q_min =\n"
        f"# topology\n"
        f"topology = {topology}\n"
    )
