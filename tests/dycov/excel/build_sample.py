...
MODEL_MAP_ROWS = [
    ...
    (
        "REGC_B|REEC_A|Aucun|Aucun|Aucun|Aucun",
        "PhotovoltaicsWeccVoltageSource1",
        "photovoltaics_",
        "PhotovoltaicsWeccVoltageSource1NoPlantControl",
        "photovoltaics_",
    ),
    (
        "REGC_B|REEC_B|Aucun|Aucun|Aucun|Aucun",
        "PhotovoltaicsWeccVoltageSource2",
        "photovoltaics_",
        "PhotovoltaicsWeccVoltageSource2NoPlantControl",
        "photovoltaics_",
    ),
    (
        "REGC_C|REEC_A|Aucun|Aucun|Aucun|Aucun",
        "PhotovoltaicsWeccVoltageSource3",
        "photovoltaics_",
        "PhotovoltaicsWeccVoltageSource3NoPlantControl",
        "photovoltaics_",
    ),
    (
        "REGC_C|REEC_B|Aucun|Aucun|Aucun|Aucun",
        "PhotovoltaicsWeccVoltageSource4",
        "photovoltaics_",
        "PhotovoltaicsWeccVoltageSource4NoPlantControl",
        "photovoltaics_",
    ),
    (
    ...
    (
        "REGC_A|REEC_A|WTGT_A|WTGP_A|WTGA_A|WTGQ_A",
        "WTG3WeccCurrentSource1",
        "WTG3_",
        "WeccWT3CurrentSource1",
        "WT3_",
    ),
    (
        "REGC_A|REEC_A|WTGT_A|WTGP_B|WTGA_A|WTGQ_A",
        "WTG3WeccCurrentSource2",
        "WTG3_",
        "WeccWT3CurrentSource2",
        "WT3_",
    ),
    (
        "REGC_A|REEC_A|WTGT_B|Aucun|Aucun|Aucun",
...
ZONE1 = [
    ...
    ("r_TG", 1, "pu"),
    ("Z_cc_TG", 0.02445, "pu"),
    ("R_cc_TG / X_cc_TG", 0.01115, "-"),
    ("Pmax_injection_z1", 90, "MW"),
    ("Pmax_soutirage_z1", 0, "MW"),
    ("Qmax_z1", 30, "MVAr"),
    ("Qmin_z1", -30, "MVAr"),
    ("P_share", 1, "-"),
    ("Q_share", 1, "-"),
...
ZONE3 = [
    ("Paramètres généraux", "SnZone3", 90, "MVA"),
    ("", "Topologie", "S+Aux", "-"),
    ("", "Un_PDR", 225, "kV"),
    ("", "Pmax_injection_PDR", 90, "MW"),
    ("", "Pmax_soutirage_PDR", 0, "MW"),
    ("", "Qmax_PDR", 30, "MVAr"),
    ("", "Qmin_PDR", -30, "MVAr"),
    ("Transformateur principal", "Z_cc_TP", 0.12, "pu"),
    ("", "R_cc_TP / X_cc_TP", 0.01, "-"),
    ("", "N_prises", 20, "-"),
    ("", "r_max", 1.1, "pu"),
    ("", "r_min", 0.9, "pu"),
    ("", "r_0", 1.05, "pu"),
    ("", "Tap_0", None, "-"),
    ("Charge auxiliaire", "Un_A", 0.69, "kV"),
    ("", "Sn_A", 1, "MVA"),
    ("", "r_TA", 1, "pu"),
    ("", "Z_cc_TA", 0.000001, "pu"),
    ("", "R_cc_TA / X_cc_TA", 0.1, "-"),
